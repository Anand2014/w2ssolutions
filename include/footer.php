...
<h4 class="widget-title"><i class="ifc-edit"></i>Recent News</h4>
...
<i class="ifc-home"></i>Our Office Location</h4>
<div class="widget widget_text">

<div class="textwidget"><p><img class="responsive-img" src="_layout/images/map.png" alt=""></p> 
<p class=" text-center last"><a href="contacts">View on live map</a></p>
</div>
<div class="textwidget footerSocialBar">
<div class="fixed">
...
<p class="last"> Copyright @ 2014 By W2S Solutions pvt ltd. All rights reserved.</p></div><!-- end .textwidget -->
</div></div>
